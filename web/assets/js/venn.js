    ...
    function bestInitialLayout(areas, params) {
        ...
        if (areas.length >= 8) {
            ...
            if (constrainedLoss + 1e-8 < greedyLoss) {
                initial = constrained;
                layoutUsed = 'constrainedMDS'
            }
        }
        console.log('layout used: ', layoutUsed)
        return initial;
    }
    ...
    function VennDiagram() {
        ...
        function chart(selection) {
            ...
            if (data.length > 0) {
                ...
                var textCentresAndDisjunctions = computeTextCentres(circles, data);
                textCentres = textCentresAndDisjunctions.ret;
                disjunctions = textCentresAndDisjunctions.disjunctions;
            }
        ...
        chart.areaDisjunctions = function(_) {
            if (!arguments.length) return disjunctions;
            return chart;
        }
